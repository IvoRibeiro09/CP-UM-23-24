...
//  Force
double F[MAXPART];
double r2_arr[2331721];
double ri_minus_rj_arr[6995161];
...
void Kinetic() { //Write Function here!  
    double kin = 0.,v2;
...
void computeAccelerations() {
    double f, rSqd, ri0, ri1, ri2, M0, M1, M2, aux, aux0, aux1, aux2, a0, a1, a2;
...
void computeAccelerations() {
    ...
    PE = 0.;
    for (i = 0; i < limit - 3;) {   // loop over all distinct pairs i,j
